...
class FieldDataProcessor:
    ...
    def weather_station_mapping(self):
        # Read weather station mapping data directly into a DataFrame\
        weather_station_data = read_from_web_CSV(self.weather_map_data)

        # Merge weather station mapping data with main DataFrame based on 'Field_ID'
        self.df = pd.merge(self.df, weather_station_data, on='Field_ID', how='left')
